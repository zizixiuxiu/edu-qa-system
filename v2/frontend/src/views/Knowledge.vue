<template>
  <div class="knowledge-page">
    ...
    <div class="filter-bar">
      <el-select v-model="filterExpert" placeholder="所有专家" clearable style="width: 160px">
        <el-option
      ...
      <el-select v-model="filterSource" placeholder="所有来源" clearable style="width: 160px">
        <el-option label="所有来源" value="" />
        <el-option label="云端质检" value="generated" />
        <el-option label="错题挖掘" value="wrong_answer_extracted" />
        <el-option label="手动添加" value="manual" />
      </el-select>
      <el-select v-model="filterQuality" placeholder="所有质量" clearable style="width: 140px">
        <el-option label="所有质量" value="" />
...
const filterExpert = ref(undefined)
  ...
  try {
    ...
    if (res.code === 200) {
      ...
      if (filterSource.value) {
        items = items.filter((k: Knowledge) => k.source_type === filterSource.value)
      }
      if (filterQuality.value) {
        items = items.filter((k: Knowledge) => {
