...
class Settings(BaseSettings):
    ...
    LLM_BASE_URL: str = Field(default="http://127.0.0.1:1234/v1", description="LLM API基础URL")
    ...
    VL_BASE_URL: str = Field(default="http://127.0.0.1:1234/v1", description="VL服务URL")
